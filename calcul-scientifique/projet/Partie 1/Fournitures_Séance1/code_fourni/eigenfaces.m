...
%% Affichage image d'entrainement
...
W = transpose(X_centre)*Y;

% Tri par ordre décroissant des valeurs propres de Sigma2 :
[D,I] = sort(diag(D), 'descend');

% Tri des eigenfaces dans le même ordre (on enlève la dernière eigenface, qui 
% appartient au noyau de Sigma) :
W = W(:, I);

% Normalisation des eigenfaces : Pas besoin sur 2020b.
