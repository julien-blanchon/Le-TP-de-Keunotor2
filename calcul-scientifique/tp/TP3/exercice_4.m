...
sum_tot = (nb_images_chrysanthemes+nb_images_oeillets+nb_images_pensees);
p_chrysanthemes = (nb_images_chrysanthemes/sum_tot)
p_oreillets = (nb_images_oeillets/sum_tot)
p_pensees = (nb_images_pensees/sum_tot)
V_chrysanthemes = V_chrysanthemes*p_chrysanthemes;
V_oeillets = V_oeillets*p_oreillets;
V_pensees = V_pensees*p_pensees;

V = cat(3, V_chrysanthemesC, V_oeilletsC, V_penseesC);
