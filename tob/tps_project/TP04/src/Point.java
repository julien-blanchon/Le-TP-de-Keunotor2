...
//  Gestion de la couleur
	...
	/**	Dessine le point sur Ecran
	 * @param ecran L'écran pour afficher
	 */
	public void dessiner(Ecran ecran){
		ecran.dessinerPoint(this.getX(), this.getY(), this.getCouleur());
	}

	/**	Dessine le point sur AfficheurSVG
	 * @param ecranSVG L'écran pour afficherSVG
	 */
	public void dessinerSVG(AfficheurSVG ecranSVG){
		ecranSVG.dessinerPoint(this.getX(), this.getY(), this.getCouleur());
	}

	/**	Dessine le point sur AfficheurTexte
	 * @param ecranTXT L'écran pour afficher
	 */
	public void dessinerTXT(AfficheurTexte ecranTXT){
		ecranTXT.dessinerPoint(this.getX(), this.getY(), this.getCouleur());
	}
}
