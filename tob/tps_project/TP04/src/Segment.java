...
public class Segment {
	...
	*/
	...
	/**	Dessine le segment sur Ecran
	 * @param ecran L'écran pour afficher
	 */
	public void dessiner(Ecran ecran){
		ecran.dessinerLigne(this.extremite1.getX(),
	...
	/**	Dessine le segment sur AfficheurSVG
	 * @param ecranSVG L'écran pour afficher
	 */
	public void dessinerSVG(AfficheurSVG ecranSVG){
		ecranSVG.dessinerLigne(this.extremite1.getX(),
				this.extremite1.getY(),
				this.extremite2.getX(),
				this.extremite2.getY(),
				this.couleur);
	...
	public void dessinerTXT(AfficheurTexte ecranTXT){
		ecranTXT.dessinerLigne(this.extremite1.getX(),
				this.extremite1.getY(),
				this.extremite2.getX(),
				this.extremite2.getY(),
				this.couleur);
