...
public class ComprendreSwingGridLayout extends JPanel {
	...
	public ComprendreSwingGridLayout() {
		super();
	...
	public static JFrame newJFrame(String titre) {
		...
		ComprendreSwingGridLayout comprendre = new ComprendreSwingGridLayout();
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(ComprendreSwingGridLayout::exemple1);
			// On demande au fil d'exécutin de Swing d'exécuter la méthode
			// exemple1 de la classe ComprendreSwingGridLayout.
