...
public class ComprendreSwingEffacer extends JPanel {
	...
	public static JFrame newJFrame(String titre) {
		...
		ComprendreSwingEffacer comprendre = new ComprendreSwingEffacer();
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(ComprendreSwingEffacer::exemple1);
			// On demande au fil d'exécutin de Swing d'exécuter la méthode
			// exemple1 de la classe ComprendreSwingEffacer.
