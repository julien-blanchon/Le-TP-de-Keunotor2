...
// final public class Point {
	/* Erreur
	java: cannot inherit from final Point
	 */
	/*
	En effet PointNomme hérite de Point donc il ne doit pas être final.
	 */
public class Point {
	...
	//Ajout de final ?!
	/* Erreur -->
	afficher() in PointNomme cannot override afficher() in Point
  overridden method is final
	 */
	/*
	En effet afficher() est overwrite dans PointNomme donc il ne faut pas que se soit un final.
	 */
	...
	/*
	On pourras calculer la distance entre un Point et un PointNomme car distance c'est une requête
	de la classe Point (et uniquement de la classe point). Ainsi lorsque l'on fait:
	PointNomme.distance(PointNomme) <--> Point.distance(Point)
	PointNomme.distance(Point) <--> Point.distance(Point)
	Point.distance(PointNomme) <--> Point.distance(Point)
	Point.distance(Point) <--> Point.distance(Point)
	 */
