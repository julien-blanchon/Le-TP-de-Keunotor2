// Test du module sequenceur(rst, clk, ir[31..16], N, Z, V, C : fetch, decode, pcplus1, adresse, branch, areg[3..0], breg[3..0], dreg[3..0], ualcmd[3..0], dbusin[1..0], write, setflags)
