...
m = 2; %2 bit par symbole pour le mapping
...
ak = [-3, -1, 1, 3]; %Mapping 4-aires a moyenne nulle
...
ylabel('map(t)');
title('Mapping ');
saveas(fig, "figures/mod2_NRZ.png");
...
saveas(fig, "figures/mod2_signal.png");

%% DSP theorique 
Sx_theo = @(f) Nt*Ts*sinc(f*Ts).^2;
...
hold off;
saveas(fig, "figures/mod2_DSP1.png");
...
hold off;
legend("DSP", "DSP Théorique");
saveas(fig, "figures/mod2_DSP2.png");